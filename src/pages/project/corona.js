...
const WorkPage = () => (
  <Layout>
    ...
    paraThree={"I developed the MVP product using React that allowed a user flow and supplemented our pitch. After 6 months we were accepted into 2 accelerator programs and have recieved funding to continue the product."} 
    imgUrl={halisi}
