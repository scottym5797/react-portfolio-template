...
const WorkPage = () => (
  <Layout>
    ...
    paraOne={"A long running product, developing both the system to create videos dynamically through connection to a product database, and also upload/manage the advertisements using these videos through Facebook Ads API."} 
    paraTwo={"Python, Postgres, OpenCV, Docker, Flask API"} 
    paraThree={"The product successfully creates videos, and runs dynamic ads in 100+ cities. As well as updates the dynamic prices and products daily."} 
