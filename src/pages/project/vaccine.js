...
const WorkPage = () => (
  <Layout>
    ...
    paraOne={"In April/May 2021 Germany allowed all individuals to access AstraZeneca Vaccine. Due to the high demand appointments were very dynamic; being booked or cancelled often. As such there needed to be a way to programmatically check for availabilities and notify those who were interested."} 
    paraTwo={"Python, Selenium"} 
    paraThree={"In an afternoon I developed a script that checked the internet (every minute) at a number of sources for available vaccine appointments in Munich and notified via email when they were available. I successfully booked appointments for myself and roughly 12 other work colleagues within the following days."} 
